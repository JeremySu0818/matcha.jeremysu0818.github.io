...
export const huCopy: LocaleCopy = {
  translation: {
    nav: {
      home: "Főoldal",
      scene3d: "3D jelenet",
    ...
    manualTutorial: {
      ...
      sieveReady: "Kattints jobb gombbal a matcha szitálásához",
      sieveReturn: "Húzd vissza a szitát a helyére",
      kettleDrag: "Húzd a vízforralót a tál fölé",
      kettleReady: "Kattints jobb gombbal a víz kiöntéséhez",
      kettleReturn: "Húzd vissza a vízforralót a helyére",
      chasenDrag: "Húzd a chasent a tál fölé",
      whisking: "Habosodásig gyors oda-vissza húzással verd fel a matchát",
  ...
  calculator: {
      ...
      description:
        "Állítsd be az adagot, az erősséget és a vízhőmérsékletet. A recepted azonnal frissül.",
      teaType: "Teatípus",
      types: {
        koicha: "Koicha",
        usucha: "Usucha",
