...
export const csCopy: LocaleCopy = {
  translation: {
    nav: {
      home: "Domů",
      scene3d: "3D scéna",
    ...
    manualTutorial: {
      ...
      sieveReady: "Klikněte pravým tlačítkem pro prosátí matcha",
      sieveReturn: "Přetáhněte sítko zpět",
      kettleDrag: "Přetáhněte konvici nad misku",
      kettleReady: "Klikněte pravým tlačítkem pro nalití vody",
      kettleReturn: "Přetáhněte konvici zpět",
      chasenDrag: "Přetáhněte metličku (chasen) nad misku",
      whisking: "Šlehejte matcha rychlým přetahováním tam a zpět, dokud se nevytvoří pěna",
  ...
  calculator: {
      ...
      description:
        "Upravte porci, sílu a teplotu vody. Váš recept se okamžitě aktualizuje.",
      teaType: "Druh čaje",
      types: {
        koicha: "Koicha",
        usucha: "Usucha",
