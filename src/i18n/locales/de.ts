...
export const deCopy: LocaleCopy = {
  translation: {
    nav: {
      home: "Startseite",
      scene3d: "3D-Szene",
    ...
    manualTutorial: {
      ...
      sieveReady: "Rechtsklick, um Matcha zu sieben",
      sieveReturn: "Ziehe das Sieb zurück",
      kettleDrag: "Ziehe den Wasserkessel über die Schale",
      kettleReady: "Rechtsklick, um Wasser einzugießen",
      kettleReturn: "Ziehe den Wasserkessel zurück",
      chasenDrag: "Ziehe den Chasen über die Schale",
      whisking: "Schlage den Matcha mit schnellem Hin-und-her-Ziehen auf, bis Schaum entsteht",
  ...
  calculator: {
      ...
      title: "Matcha zubereiten",
      description:
        "Passe Portion, Stärke und Wassertemperatur an. Dein Rezept wird sofort aktualisiert.",
      teaType: "Tee-Typ",
      types: {
        koicha: "Koicha",
        usucha: "Usucha",
