...
export const viCopy: LocaleCopy = {
  translation: {
    nav: {
      home: "Trang chủ",
    ...
    manualTutorial: {
      ...
      sieveReady: "Nhấp chuột phải để rây matcha",
      sieveReturn: "Kéo rây để đưa về vị trí cũ",
      kettleDrag: "Kéo ấm nước lên trên bát",
      kettleReady: "Nhấp chuột phải để rót nước",
      kettleReturn: "Kéo ấm nước để đưa về vị trí cũ",
      chasenDrag: "Kéo chasen lên trên bát",
      whisking: "Đánh matcha bằng cách kéo nhanh qua lại cho đến khi nổi bọt",
  ...
  calculator: {
      ...
      description:
        "Điều chỉnh định lượng, độ đậm đặc và nhiệt độ nước. Công thức của bạn sẽ cập nhật ngay lập tức.",
      teaType: "Loại trà",
      types: {
        koicha: "Koicha",
        usucha: "Usucha",
