...
export const plCopy: LocaleCopy = {
  translation: {
    nav: {
      home: "Start",
      scene3d: "Scena 3D",
    ...
    manualTutorial: {
      ...
      sieveReady: "Kliknij prawym przyciskiem myszy, aby przesiać matchę",
      sieveReturn: "Przeciągnij sitko, aby je odłożyć",
      kettleDrag: "Przeciągnij czajnik nad miskę",
      kettleReady: "Kliknij prawym przyciskiem myszy, aby nalać wodę",
      kettleReturn: "Przeciągnij czajnik, aby go odłożyć",
      chasenDrag: "Przeciągnij chasen nad miskę",
      whisking: "Ubijaj matchę szybkim przeciąganiem tam i z powrotem, aż pojawi się pianka",
  ...
  calculator: {
      ...
      description:
        "Dostosuj porcję, moc oraz temperaturę wody. Twój przepis zaktualizuje się natychmiast.",
