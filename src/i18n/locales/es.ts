...
export const esCopy: LocaleCopy = {
  translation: {
    nav: {
      home: "Inicio",
      scene3d: "Escena 3D",
    ...
    manualTutorial: {
      ...
      sieveReady: "Haz clic derecho para tamizar el matcha",
      sieveReturn: "Arrastra el colador para devolverlo",
      kettleDrag: "Arrastra el hervidor sobre el bol",
      kettleReady: "Haz clic derecho para verter agua",
      kettleReturn: "Arrastra el hervidor para devolverlo",
      chasenDrag: "Arrastra el chasen sobre el bol",
      whisking: "Bate el matcha arrastrando rápidamente de un lado a otro hasta que salga espuma",
  ...
  calculator: {
      ...
      description:
        "Ajusta la porción, la intensidad y la temperatura del agua. Tu receta se actualizará al instante.",
      teaType: "Tipo de té",
      types: {
        koicha: "Koicha",
        usucha: "Usucha",
