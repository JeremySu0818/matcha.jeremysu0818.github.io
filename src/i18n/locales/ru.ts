...
export const ruCopy: LocaleCopy = {
  translation: {
    ...
    manualTutorial: {
      ...
      sieveReady: "Щелкните правой кнопкой мыши (или удерживайте), чтобы просеять матча",
      sieveReturn: "Перетащите сито обратно",
      kettleDrag: "Перетащите чайник над чашей",
      kettleReady: "Щелкните правой кнопкой мыши (или удерживайте), чтобы налить воду",
      kettleReturn: "Перетащите чайник обратно",
      chasenDrag: "Перетащите тясэн над чашей",
      whisking: "Взбейте матча, быстро перемещая тясэн вперед и назад",
