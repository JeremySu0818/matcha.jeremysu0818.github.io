...
export const enCopy: LocaleCopy = {
  translation: {
    nav: {
      home: "Home",
      scene3d: "3D Scene",
  ...
  calculator: {
      ...
      description:
        "Adjust the serving, strength, and water temperature. Your recipe updates instantly.",
      teaType: "Tea type",
      types: {
        koicha: "Koicha",
        usucha: "Usucha",
