...
export const koCopy: LocaleCopy = {
  translation: {
    ...
    chapters: {
      ...
      chapter4: {
        waTitle: "화 (조화)",
        waDesc: "환경, 타인, 그리고 자신과의 진정한 화해.",
        keiTitle: "경 (존경)",
        keiDesc: "모든 것에 격식 없는 진정한 존경심을 갖는 것.",
        seiTitle: "청 (청정)",
        seiDesc: "속세의 잡념을 버리고 마음을 맑게 유지하는 것.",
        jakuTitle: "적 (고요)",
        jakuDesc: "고요함 속에서 영적 충만함을 느끼고 소외되지 않는 것.",
        eyebrow: "제 4장",
        title: "화, 경, 청, 적,\n한 평생을 담은 네 글자",
    ...
    final: {
      ...
      p2: "이제 3D 몰입형 인터랙티브 체험을 시작합니다. 단계별 수동 조작을 통해 여러분의 템포에 맞춰 말차 가루 떨어뜨리기, 체 치기, 물 붓기, 거품 내기까지의 전 과정이 유연하게 연출됩니다. 나만의 리듬에 따라 차 한 잔이 탄생하는 순간을 감상해보세요.",
      button: "3D 장면 시작",
    },
    loader: {
      preparing: "준비 중",
