...
export const arCopy: LocaleCopy = {
  translation: {
    ...
    manualTutorial: {
      ...
      sieveReady: "انقر بزر الماوس الأيمن (أو اضغط مع الاستمرار) لغربلة الماتشا",
      sieveReturn: "اسحب المنخل لإعادته",
      kettleDrag: "اسحب الغلاية فوق الوعاء",
      kettleReady: "انقر بزر الماوس الأيمن (أو اضغط مع الاستمرار) لصب الماء",
      kettleReturn: "اسحب الغلاية لإعادتها",
      chasenDrag: "اسحب الشاسين (مخفقة الخيزران) فوق الوعاء",
      whisking: "اخفق الماتشا عن طريق السحب بسرعة ذهابًا وإيابًا",
      done: "اكتملت الطقوس",
    },
  },
  tools: {
