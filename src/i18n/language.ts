export const SUPPORTED_LANGUAGES = [
  'ar', 'cs', 'de', 'en', 'es', 'fr', 'hi', 'hu', 'id', 'it',
  'ja', 'ko', 'nl', 'pl', 'pt-br', 'ru', 'tr', 'vi', 'zh-cn', 'zh-tw'
] as const;
...
export function getBrowserLanguage(): SupportedLanguage {
  ...
  for (const lang of languages) {
    ...
    // Special handling for Chinese (zh)
    if (base === 'zh') {
    ...
    // Special handling for Portuguese (pt) -> pt-br
    if (base === 'pt') {
      return 'pt-br';
    }
