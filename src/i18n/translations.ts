...
export const translations: Record<SupportedLanguage, TranslationSchema> = {
  'zh-tw': {
    ...
    hero: {
      eyebrow: '專注的儀式',
      title: '喚醒\n你的感官',
      description: '在這個什麼都講求快速的時代，抹茶偏偏要你放慢下來。沒辦法急，急了就沒了那個味道。向下捲動，讓我們慢慢聊聊這杯茶的故事。',
      scroll: '向下捲動',
    },
    chapters: {
      chapter1: {
  ...
  'zh-cn': {
    ...
    hero: {
      eyebrow: '专注的仪式',
      title: '唤醒\n你的感官',
      description: '在这个什么都讲求快速的时代，抹茶偏偏要你放慢下来。没办法急，急了就没了那个味道。向下滚动，让我们慢慢聊聊这杯茶的故事。',
      scroll: '向下滚动',
    },
    chapters: {
      chapter1: {
  ...
  'en': {
    ...
    hero: {
      ...
      title: 'Awaken\nYour Senses',
      description: 'In an era that demands speed, matcha gently asks you to slow down. It cannot be rushed; speed would only spoil the taste. Scroll down, and let us slowly tell the story of this tea.',
      scroll: 'Scroll down',
    },
    chapters: {
      chapter1: {
  ...
  'ja': {
    ...
    hero: {
      eyebrow: '精神を研ぎ澄ます儀式',
      title: '五感を\n呼び覚ます',
      description: '何事にもスピードが求められる現代において、抹茶はゆっくりと立ち止まることを教えてくれます。焦っては、その繊細な味わいは生まれません。スクロールして、この一杯のお茶の物語を紐解いてみましょう。',
      scroll: 'スクロールする',
    },
    chapters: {
      chapter1: {
  ...
  'ko': {
    ...
    hero: {
      eyebrow: '집중의 의식',
      title: '감각을\n깨우다',
      description: '모든 것이 빠르게 흘러가는 이 시대에 말차는 천천히 가라고 말합니다. 서두르면 고유의 맛을 잃게 됩니다. 아래로 스크롤하여 이 차에 담긴 이야기를 천천히 만나보세요.',
      scroll: '스크롤',
    },
    chapters: {
      chapter1: {
  ...
  'de': {
    ...
    metadata: {
      title: 'Matcha - Ichigo Ichie',
      description: 'Ein scrollgesteuertes 3D-Ritual zur Zubereitung einer Schale Matcha.',
    },
    header: {
      title: 'Matcha',
    },
    hero: {
      ...
      title: 'Wecke\ndeine Sinne',
      description: 'In einer Zeit, die Schnelligkeit verlangt, lädt Matcha zum Entschleunigen ein. Es darf nicht gehetzt werden; Eile würde nur den Geschmack verderben. Scrollen Sie nach unten, um die Geschichte dieses Tees zu erfahren.',
  ...
  'es': {
    ...
    metadata: {
      title: 'Matcha - Ichigo Ichie',
      description: 'Un ritual en 3D para preparar un tazón de matcha guiado por el movimiento.',
    },
    header: {
      title: 'Matcha',
    },
    hero: {
      ...
      title: 'Despierta\ntus sentidos',
      description: 'En una era que exige rapidez, el matcha nos pide ir más despacio. No se puede tener prisa; la prisa arruinaría el sabor. Desplácese hacia abajo y descubra la historia de este té.',
  ...
  'fr': {
    ...
    hero: {
      ...
      title: 'Éveillez\nvos sens',
      description: 'Dans un monde qui exige de la rapidité, le matcha nous invite à ralentir. Il ne peut être pressé, sous peine d\'en gâcher la saveur. Faites défiler vers le bas pour découvrir son histoire.',
  ...
  'it': {
    ...
    metadata: {
      title: 'Matcha - Ichigo Ichie',
      description: 'Un rituale 3D guidato dallo scorrimento per preparare una tazza di matcha.',
    },
    header: {
      title: 'Matcha',
    },
    hero: {
      ...
      title: 'Risveglia\ni tuoi sensi',
      description: 'In un\'epoca che esige rapidità, il matcha ci chiede di rallentare. Non si può avere fretta; la fretta rovinerebbe il sapore. Scorri verso il basso e scopri la storia di questo tè.',
  ...
  'pt-br': {
    ...
    metadata: {
      title: 'Matcha - Ichigo Ichie',
      description: 'Um ritual em 3D guiado por rolagem para preparar uma tigela de matcha.',
    },
    header: {
      title: 'Matcha',
    },
    hero: {
      ...
      title: 'Desperte\nseus sentidos',
      description: 'Em uma era que exige rapidez, o matcha nos pede para ir mais devagar. Não se pode ter pressa; a pressa arruinaria o sabor. Role para baixo e descubra a história deste chá.',
  ...
  'ru': {
    ...
    metadata: {
      title: 'Matcha - Ichigo Ichie',
      description: 'Интерактивный 3D-ритуал приготовления чая матча при прокрутке.',
    },
    header: {
      title: 'Matcha',
    },
    hero: {
      ...
      title: 'Пробудите\nсвои чувства',
      description: 'В эпоху, когда все спешат, матча просит нас замедлиться. Спешка испортит вкус. Прокрутите вниз, чтобы узнать историю этого чая.',
  ...
  'tr': {
    ...
    hero: {
      ...
      title: 'Duyularını\nUyandır',
      description: 'Hız talep eden bu çağda, matcha sizden yavaşlamanızı ister. Aceleye gelmez; acele etmek tadını bozar. Aşağı kaydırın ve bu çayın hikayesini öğrenin.',
      scroll: 'Aşağı kaydır',
    },
    chapters: {
      chapter1: {
  ...
  'vi': {
    ...
    hero: {
      ...
      title: 'Đánh thức\ngiác quan',
      description: 'Trong thời đại vội vã này, matcha nhẹ nhàng nhắc ta chậm lại. Không thể gấp gáp; vội vàng sẽ làm hỏng hương vị. Cuộn xuống để lắng nghe câu chuyện về chén trà này.',
      scroll: 'Cuộn xuống',
    },
    chapters: {
      chapter1: {
  ...
  'ar': {
    ...
    hero: {
      ...
      title: 'أيقظ\nحواسك',
      description: 'في عصر يطالب بالسرعة، تطلب منك الماتشا التمهل. لا يمكن الاستعجال؛ فالسرعة تفسد المذاق. مرر للأسفل وتعرف على قصة هذا الشاي.',
      scroll: 'مرر للأسفل',
    },
    chapters: {
      chapter1: {
  ...
  'cs': {
    ...
    hero: {
      ...
      title: 'Probuďte\nsvé smysly',
      description: 'V uspěchané době nás matcha žádá, abychom zpomalili. Nelze spěchat; spěch by jen zkazil chuť. Přejděte dolů a objevte příběh tohoto čaje.',
      scroll: 'Přejít dolů',
    },
    chapters: {
      chapter1: {
  ...
  'hi': {
    ...
    metadata: {
      ...
      description: 'माचा चाय का एक प्याला तैयार करने की स्क्रॉल-आधारित 3D विधि।',
    },
    header: {
      title: 'Matcha',
    },
    hero: {
      ...
      description: 'तेजी की मांग करने वाले इस युग में, माचा आपसे धीमे होने का अनुरोध करता है। जल्दबाजी नहीं की जा सकती; जल्दबाजी से स्वाद बिगड़ जाता है। नीचे स्क्रॉल करें और इस चाय की कहानी जानें।',
  ...
  'hu': {
    ...
    hero: {
      ...
      description: 'Egy olyan korban, amely gyorsaságot követel, a matcha arra kér, hogy lassíts le. Nem lehet siettetni; a sietség csak elrontaná az ízét. Görgess lejjebb, és ismerd meg a tea történetét.',
      scroll: 'Görgess le',
    },
    chapters: {
      chapter1: {
  ...
  'id': {
    ...
    metadata: {
      title: 'Matcha - Ichigo Ichie',
      description: 'Ritual pembuatan secangkir matcha 3D interaktif berbasis guliran.',
    },
    header: {
      title: 'Matcha',
    },
    hero: {
      ...
      title: 'Bangkitkan\nIndramu',
      description: 'Di era yang menuntut kecepatan, matcha meminta kita untuk melambat. Tidak bisa terburu-buru; tergesa-gesa hanya akan merusak rasa. Gulir ke bawah dan ketahui kisah teh ini.',
  ...
  'nl': {
    ...
    metadata: {
      title: 'Matcha - Ichigo Ichie',
      description: 'Een scroll-gestuurd 3D ritueel voor het bereiden van een kom matcha.',
    },
    header: {
      title: 'Matcha',
    },
    hero: {
      ...
      title: 'Ontwaak\nje zintuigen',
      description: 'In een tijdperk dat snelheid eist, vraagt matcha je om te vertragen. Je kunt het niet haasten; haast zou de smaak bederven. Scroll naar beneden en ontdek het verhaal van deze thee.',
  ...
  'pl': {
    ...
    metadata: {
      title: 'Matcha - Ichigo Ichie',
      description: 'Sterowany przewijaniem interaktywny rytuał przygotowania czarki herbaty matcha 3D.',
    },
    header: {
      title: 'Matcha',
    },
    hero: {
      ...
      title: 'Obudź\nswoje zmysły',
      description: 'W czasach wymagających szybkości matcha prosi nas o zwolnienie tempa. Nie da się przyspieszyć; pośpiech zepsułby smak. Przewiń w dół i poznaj historię tej herbaty.',
